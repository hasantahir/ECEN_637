...
%           2. Gaussian
%           3. Pulse
%   far_field() = Models the Contour integration of the equivalent sources
...
h2.Color = 'black';
h2.LineWidth = 1.4;
title(['Cartesian Radiation Pattern of a PEC Box at f =  ',int2str(finc/1e6), ' MHz'],'Interpreter','latex')
set(gcf,'Color','white'); % Set background color to white
set(gca,'FontName','times new roman') % Set axes fonts to Times New Roman
ax = gca;
...
ylabel('$\sqrt{RCS/\lambda_0}$ ','Interpreter','latex'); % y-axis label
axis([ 0 2*pi 0 2.6]) % Set the x- and y- limits according to thee paper
grid on
